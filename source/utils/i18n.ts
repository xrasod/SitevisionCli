...
const sv: Record<string, string> = {
	...
	'⚠ plaintext password in .dev_properties.json · / migrate':
		'⚠ lösenord i klartext funna i .dev_properties.json · / migrera',
	RECENT: 'SENASTE',
	...
	Help: 'Hjälp',
	'every key in one place': 'alla kortkommandon på ett ställe',
	Keys: 'Tangenter',
	'Esc close': 'Esc stäng',
	Here: 'Här',
	...
	env: 'miljö',
	'↑ dev': '↑ dev',
	'Activate a remote version': 'Aktivera en uppladdad version',
	'Stop running task': 'Stoppa pågående körning',
	...
	'Authorization endpoint': 'Authorization url',
	...
	'Space-separated scopes to request. ALL grants the Sitevision API and offline_access adds a refresh token so later runs log in silently. Match the casing your client expects.':
		'Scopes att begära, separerade med mellanslag. ALL ger Sitevision-API:et och offline_access ger en refresh-token så att senare körningar loggar in tyst. Skriftlägesskänsligt.',
	...
	'Update check': 'Uppdateringskoll',
	'Addon name warning': 'Varning om tilläggsnamn',
	'Default signing user': 'Förvald signeringsanvändare',
	'Default certificate': 'Förvalt certifikat',
	'The language svc itself speaks.': 'Språket som svc självt använder.',
	'Play the logo animation when the shell starts.':
		'Spela logotypanimationen när skalet startar.',
	'Look for a newer svc on npm at start.':
		'Leta efter en nyare svc på npm vid start.',
	'Mark the addon name with ≠ manifest when it is none of the names in manifest.json.':
		'Markera tilläggsnamnet med ≠ manifest när det inte är något av namnen i manifest.json.',
	'The developer.sitevision.se account that signs in every project without a signing user of its own.':
		'Kontot på developer.sitevision.se som signerar i alla projekt utan egen signeringsanvändare.',
	'Which certificate signs when the account has several. Empty = the account default.':
		'Vilket certifikat som signerar när kontot har flera. Tomt = kontots standard.',
	'Enter confirm · Esc cancel': 'Enter bekräfta · Esc avbryt',
	'Not saved: the settings file does not parse.':
		'Inte sparat: inställningsfilen går inte att tolka.',
	'The settings file does not parse and is ignored until it is fixed.':
		'Inställningsfilen går inte att tolka och ignoreras tills den är lagad.',
	global: 'global',
	on: 'på',
	off: 'av',
	'Saved.': 'Sparat.',
